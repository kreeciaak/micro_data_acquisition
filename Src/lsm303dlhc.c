...
void LSM_Mag_GetXYZ(int16_t* pData)
{
	...
	buffer[2] = LSM_I2C_Read(LSM303DLHC_ADDRESS_M,LSM303DLHC_RA_OUT_Z_H_M);
	buffer[3] = LSM_I2C_Read(LSM303DLHC_ADDRESS_M,LSM303DLHC_RA_OUT_Z_L_M);
	buffer[4] = LSM_I2C_Read(LSM303DLHC_ADDRESS_M,LSM303DLHC_RA_OUT_Y_H_M);
	buffer[5] = LSM_I2C_Read(LSM303DLHC_ADDRESS_M,LSM303DLHC_RA_OUT_Y_L_M);
